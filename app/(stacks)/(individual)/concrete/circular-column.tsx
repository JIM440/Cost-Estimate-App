...
export default function ConcreteCircularColumnScreen() {
  const { colors } = useTheme();
  return (
    <View style={{ flex: 1, backgroundColor: colors.screen_background }}>
      <StackHeader titleKey="estimate.concrete.type.circularColumn" />
      <ScreenWrapper style={{ paddingVertical: 16, paddingBottom: 100 }}>
        <ConcreteScreen initialType="circularColumn" singleTypeMode />
      </ScreenWrapper>
    </View>
  );
}
