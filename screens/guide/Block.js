...
const BlocksCostGuide = () => {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.heading}>Step-by-Step Guide: Estimating Block Masonry Cost</Text>
      ...
      <Text style={styles.equation}>Wall Volume (m³) = (Length × Width - Area to Subtract) × Height</Text>
      ...
      <Text style={styles.equation}>Number of Blocks = Ceil(Wall Volume / Block Volume)</Text>

      {/* Step 5: Calculate Dry Mortar Volume */}
      <Text style={styles.step}>5. Calculate Dry Mortar Volume</Text>
      <Text style={styles.text}>
        Calculate the volume of dry mortar required for laying the blocks (assuming 1:6 mortar mix):
      </Text>
      <Text style={styles.equation}>Dry Mortar Volume (m³) = Wall Volume × 1.54</Text>
      ...
      <Text style={styles.equation}>Sand Volume (m³) = (Dry Mortar Volume × 3) / 4</Text>
      ...
      <Text style={styles.equation}>Cement Volume (m³) = (Dry Mortar Volume × 1) / 4</Text>
      <Text style={styles.equation}>Cement Weight (kg) = Cement Volume × 1440</Text>
      ...
      <Text style={styles.text}>
        Determine the total cost of blocks based on the number of blocks and price per block:
      </Text>
      <Text style={styles.equation}>Total Block Cost = Number of Blocks × Price per Block</Text>
    </ScrollView>
  );
};
