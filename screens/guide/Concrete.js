...
const ConcreteCostGuide = () => {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.heading}>Step-by-Step Guide: Estimating Concrete Cost</Text>
      ...
      <Text style={styles.equation}>Total Volume of Concrete (m³) = Length × Width × Height</Text>

      {/* Step 4: Calculate Dry Volume of Concrete */}
      <Text style={styles.step}>4. Calculate Dry Volume of Concrete</Text>
      <Text style={styles.text}>
        Calculate the dry volume of concrete, accounting for 54% increase due to mixing:
      </Text>
      <Text style={styles.equation}>Dry Volume of Concrete (m³) = Total Volume of Concrete × 1.54</Text>

      {/* Step 5: Calculate Cement and Aggregate Volumes */}
      <Text style={styles.step}>5. Calculate Cement and Aggregate Volumes</Text>
      <Text style={styles.text}>
        Calculate the volumes of cement, sand, and aggregate required based on standard mix proportions:
      </Text>
      <Text style={styles.equation}>Cement Volume (m³) = Dry Volume of Concrete × (1/7)</Text>
      <Text style={styles.equation}>Sand Volume (m³) = Dry Volume of Concrete × (0.55)</Text>
      <Text style={styles.equation}>Aggregate Volume (m³) = Dry Volume of Concrete × (0.45)</Text>
      ...
      <Text style={styles.equation}>Number of Cement Bags = Ceil(Cement Volume / 0.035)</Text>

      {/* Step 7: Calculate Concrete Cost */}
      <Text style={styles.step}>7. Calculate Concrete Cost</Text>
      <Text style={styles.text}>
        Determine the total cost of concrete based on the volume and price per m³:
      </Text>
      <Text style={styles.equation}>Total Concrete Cost = Dry Volume of Concrete × Price per m³</Text>
    </ScrollView>
  );
};
