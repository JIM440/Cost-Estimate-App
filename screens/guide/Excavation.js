...
const ExcavationCostGuide = () => {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.heading}>Step-by-Step Guide: Estimating Excavation Cost</Text>
      ...
      <Text style={styles.equation}>Total Volume = Length × Width × Depth + 0.3 × Volume</Text>
