...
const PlasteringCostGuide = () => {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.heading}>Step-by-Step Guide: Estimating Plastering Cost</Text>
      ...
      <Text style={styles.equation}>Total Area (m²) = Length × Width - Opening Area</Text>
      ...
      <Text style={styles.equation}>Total Volume (m³) = Total Area × Thickness × (1 + 0.3)</Text>
      ...
      <Text style={styles.equation}>Dry Volume (m³) = Total Volume × 1.54</Text>
      ...
      <Text style={styles.equation}>Cement Volume (m³) = Dry Volume / 3</Text>
      ...
      <Text style={styles.text}>
        Calculate the volume of sand required:
      </Text>
      <Text style={styles.equation}>Sand Volume (m³) = (Dry Volume × 2) / 3</Text>

      {/* Step 8: Calculate Plaster Cost */}
      <Text style={styles.step}>8. Calculate Plaster Cost</Text>
      <Text style={styles.text}>
        Determine the total cost of plastering based on the calculated dry volume and price per m²:
      </Text>
      <Text style={styles.equation}>Total Plaster Cost = Dry Volume × Price per m²</Text>
    </ScrollView>
  );
};
