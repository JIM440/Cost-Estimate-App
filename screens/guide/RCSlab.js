  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.text}>
        To estimate the materials and quantities for the RC slab, you will need
      ...
      <Text style={styles.text}>Determine the area of the RC slab:</Text>
      ...
      <Text style={styles.equation}>
        Concrete Volume (m³) = Area of Slab (m²) × Thickness of Slab (m)
      </Text>
      ...
      <Text style={styles.equation}>
        Number of 12m Rods = (Rods in X-direction × Width of Slab / 12) + (Rods
        in Y-direction × Length of Slab / 12)
      </Text>
      ...
      <Text style={styles.step}>
        6. Calculate Volume of Gravel, Sand, and Cement
      </Text>
      <Text style={styles.text}>
        Determine the volumes of gravel, sand, and cement based on the ratio
        1:1:2 (cement:gravel:sand):
      </Text>
      <Text style={styles.equation}>
      ...
      <Text style={styles.equation}>
        Volume of Cement = Dry Volume of Concrete × Cenent Ratio / Sum of Ratio
      </Text>
