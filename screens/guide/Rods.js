...
const RodCostGuide = () => {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.heading}>Step-by-Step Guide: Estimating Rod Cost</Text>
      ...
      <Text style={styles.equation}>Rod Weight (kg) = (Diameter² × Length) / 162</Text>

      {/* Step 4: Calculate Total Weight */}
      <Text style={styles.step}>4. Calculate Total Weight</Text>
      <Text style={styles.text}>
        Calculate the total weight for all rods:
      </Text>
      <Text style={styles.equation}>Total Weight (kg) = Rod Weight (kg) × Number of Rods</Text>
      ...
      <Text style={styles.equation}>Total Cost = Total Weight (kg) × Price per kg</Text>
      ...
      <Text style={styles.equation}>Rod Volume (m³) = π × (Diameter/2)² × Length</Text>
    </ScrollView>
  );
};
