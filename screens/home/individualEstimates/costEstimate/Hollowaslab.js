...
const HollowSlab = () => {
    ...
    const HBEstimate = () => {
        ...
        const areaOfBlock = parseInt(HBSlabBlockLength) * parseInt(HBSlabBlockWidth);
        ...
        const numRods = Math.ceil(parseInt(HBSlabSpan) / parseInt(HBSlabBlockWidth));
    ...
    return (
        <ScrollView style={containerStyles.scrollContainer}>
          <Image style={image.image} source={require('../../../../assets/images/individual_estiamte/hollow_slab_c.jpg')} />
            <View style={containerStyles.container}>
                ...
                <View style={inputStyles.threeColumn}>
                    <TextInputTitle
                        style={inputStyles.threeColumnInput} placeholder="Enter Length"
                        value={HBSlabLength}
                        title='Length (m)' onChange={(text) => setHBSlabLength(text)}
                    />
                    <TextInputTitle
                        style={inputStyles.threeColumnInput}
                        placeholder="Enter Width"
                        value={HBSlabWidth}
                        title='Width (m)' onChange={(text) => setHBSlabWidth(text)}
                    />
                    <TextInputTitle
                        style={inputStyles.threeColumnInput}
                        placeholder="Enter Thickness"
                        value={HBSlabThickness}
                        title='Thickness (m)' onChange={(text) => setHBSlabThickness(text)}
                    />
                ...
                <View style={inputStyles.threeColumn}>
                    <TextInputTitle
                        ...
                        title='Length of Block (m)' onChange={(text) => setHBSlabBlockLength(text)}
                    />
                    <TextInputTitle
                        style={inputStyles.twoColumnInput}
                        placeholder="Enter Width"
                        value={HBSlabBlockWidth}
                        title='Width of Block (m)' onChange={(text) => setHBSlabBlockWidth(text)}
                    />
                </View>
                <TextInputTitle
                    placeholder="Enter Span"
                    value={HBSlabSpan}
                    title='Span between Blocks (m)' onChange={(text) => setHBSlabSpan(text)}
                />
                ...
                <View style={tableStyles.container}>
                    ...
                    <View style={tableStyles.row}>
                        ...
                        <View style={tableStyles.column}>
                            <Text style={tableStyles.cell}>{HBSlabEstimate.numBagsCement}</Text>
                        </View>
                        <View style={tableStyles.column}>
